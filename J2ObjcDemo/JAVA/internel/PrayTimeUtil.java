...
// Adjusting Methods for Higher Latitudes
//        this.setAngleBased(0); // angle/60th of night
//        this.setOneSeventh(1); // 1/7th of night
//        this.setMidNight(2); // middle of night
//        this.setNone(3); // No adjustment
...
// double R = 1.00014 - 0.01671 * [self dcos:g] - 0.00014 * [self dcos:
    ...
    public String floatToTime12(double time, boolean noSuffix) {
         ...
         */
        if (noSuffix == false) {
            if (isLessTen(hours) && isLessTen(minutes)) {
                result = "0" + hours + ":0" + Math.round(minutes) + " "
                        + suffix;
            } else if (isLessTen(hours)) {
                result = "0" + hours + ":" + Math.round(minutes) + " " + suffix;
            } else if (isLessTen(minutes)) {
     ...
     * @return
     */
    private boolean isLessTen(int number){
     ...
     * @return
     */
    private boolean isLessTen(double number){
        return (number>=0 && number <= 9);
    }
